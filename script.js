// Code administrateur - sera chargé depuis le serveur ou utiliser le fallback
let ADMIN_CODE = window.ADMIN_CODE_REMOTE || '268977';
...
async function sellWeaponWithCustomPrice() {
    ...
    if (window.db) {
        try {
            ...
            // CRITIQUE: Utiliser increment pour éviter les conflits de synchronisation
