...
app.get('/api/config', (req, res) => {
  res.json({
    firebase: {
      apiKey: process.env.FIREBASE_API_KEY || 'AIzaSyBwOdTdK5PWarW0Xrz7S9uFstsgdw0uaoc',
    ...
    adminCode: process.env.ADMIN_CODE || '268977'
  });
});
...
app.post('/api/admin/verify', (req, res) => {
  const { code } = req.body;
  const adminCode = process.env.ADMIN_CODE || '268977';
